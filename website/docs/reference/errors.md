...
| `ConfigValidationError` | `CONFIG_VALIDATION_ERROR` | 400 | 1 | `(message)` | Bot configuration failed cross-field validation (e.g., mutually exclusive fields set together) |
...
- [Configuration](/guide/configuration) -- Auth errors
