...
Array of all valid capability strings: `"query"`, `"read_workspace"`, `"write_workspace"`, `"execute"`, `"read_sessions"`, `"lifecycle"`, `"bus_publish"`, `"bus_subscribe"`, `"bus_queue"`, `"workflow_run"`, `"workflow_manage"`, `"gateway_outbound"`, `"meta"`.
