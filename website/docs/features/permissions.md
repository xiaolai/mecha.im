...
| `bus_publish` | Publish messages to bus topics |
| `bus_subscribe` | Subscribe to bus topics |
| `bus_queue` | Push/claim queue items |
| `workflow_run` | Trigger workflow runs |
| `workflow_manage` | Create/cancel workflows |
| `gateway_outbound` | Call external APIs via gateway |
| `meta` | Full system access (spawn/kill bots, system-wide operations) |
