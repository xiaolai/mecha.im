...
type Filter interface {
	Apply(ctx context.Context, ev *events.Event, res Result) (Result, Decision, error)
}
...
func (d *DenyAll) Apply(_ context.Context, _ *events.Event, res Result) (Result, Decision, error) {
	var denied []string
	if res.Comment != nil {
...
func (a *AllowAll) Apply(_ context.Context, _ *events.Event, res Result) (Result, Decision, error) {
	var allowed []string
	if res.Comment != nil {
