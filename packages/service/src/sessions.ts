...
/* v8 ignore start -- trivial URL builder, tested indirectly via botSessionGet/Delete */
...
/* v8 ignore start -- helper only called from botSessionListFromDisk */
...
/* v8 ignore start -- requires bot filesystem structure with config.json and .claude/projects/ */
