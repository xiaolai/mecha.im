...
/** Token usage and model info extracted from an API response */
...
/** Mutable state accumulated across SSE chunks during stream parsing */
...
/** Create a fresh SSEParseState for a new streaming request */
