/** Input fields to validate for bot configuration compatibility rules. */
...
/** Result of bot config validation containing errors and warnings. */
...
/** Validate bot spawn settings for mutual exclusion and safety constraints. */
