...
export function OfficeCanvas({
  ...
  // Game loop control ref
  const gameLoopRef = useRef<{ stop: () => void; pause: () => void; resume: () => void } | null>(null);
  ...
  useEffect(() => {
    ...
    const gameLoop = startGameLoop(canvas, {
      update: (dt) => {
  ...
  // Pause/resume game loop based on isActive prop
  useEffect(() => {
